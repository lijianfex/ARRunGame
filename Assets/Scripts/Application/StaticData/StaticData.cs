...
public class StaticData : MonoSingleton<StaticData>
{
    ...
    {
        m_FootballDataDis.Add(0, new FootballData(0, FootballMaterialList[0]));
        m_FootballDataDis.Add(1, new FootballData(200, FootballMaterialList[1]));
        m_FootballDataDis.Add(2, new FootballData(400, FootballMaterialList[2]));
    }
